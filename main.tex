...
Das Ergebnis dieser Schritte enthält - wenn auch nicht für Menschen verständlich - sehr vereinfacht gesagt fast alle Informationen, die es zum Eingabetext geben kann -- inklusive der Verbesserungen von Unklarheiten und Fehlern --, nur in sehr kondensierter Form. \cite[Abs. 22--23]{patrickstolp_transformer}
