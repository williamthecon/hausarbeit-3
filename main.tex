...
Die Lokalisierung stellt gewissermaßen gar keine Herausforderung mehr dar. Es handelt sich grundsätzlich nur noch um eine Frage der Zeit, bis viele KI-Anwendungwn auf den meisten Mobilgeräten laufen können;\ct{androidcentral_ondevice_ai_processing}{Abs. 1--3,12--15} die neuesten Google-Pixel-Modelle unterstützen sogar schon Googles Gemini-Nano-Modell, eine deutlich verkleinerte Version des großen Modells,\ct{androidauthority_gemini_nano}{Abs. 3--4} lokal zu laufen.\ct{google_gemini_nano_pixel_10_updates}{Abs. 2}
...
Alles in allem ist \term{Kontext} das wichtigste Wort dieses ganzen Themenbereichs: Alles richtet sich nur noch danach, den Kontext so ganzheitlich und aber nuanciert zu erfassen und darauf basiert zu handeln. \usfw{LLMs}, \usfw{embedding vectors} und \usfw{attention layers} spielen dabei eine sehr große Rolle.
...
Neben diesem ambitionierten Ziel steht allerdings auch grundsätzlich die Auseinandersetzung mit den alten und neuen, aber hauptsächlich erfolgreichsten Ansätzen der Sprachkorrektur- und -vorhersagealgorithmen und damit, ob die Theorie in der Praxis bestätigt oder entkräftet wird.
...
Sprachverarbeitung ist schließlich ein sich rasant weiterentwickelndes Feld, in dem mit großen Ambitionen geforscht und in das vor allen Dingen mit viel Geld investiert wird. Neu entwickelte Technologien können ältere schnell übertreffen und für den Normalgebrauch irrelevant machen.
