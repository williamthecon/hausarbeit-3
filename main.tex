...
Oberflächlich ist an der Sprachkorrektur und -vorhersage erst einmal nicht viel auffällig. Auch im Rahmen dieser Arbeit ist es nicht möglich, über eine grobe Betrachtung hinauszukommen, denn die erläuterten Konzepte sind sehr weitgefasst und umfassen viele weitere Konzepte: Besonders Neuronale Netze, Künstliche Intelligenz und \usfw{machine learning} sind in einer aufwärts strebenden Entwicklungsphase und versprechen neben einem großen Einfluss auf die globale Zukunft auch der Wissenschaft und Forschung noch viele neue Ideen, die zu den vielen teilweise erst jüngst entdeckten dazukommen.
...
Alles in allem ist \term{Kontext} das wichtigstes Wort dieses ganzen Themas: Alles richtet sich nur noch danach, den Kontext so ganzheitlich und aber nuanciert zu erfassen und darauf basiert zu handeln. \usfw{LLMs}, \usfw{embedding vectors} und \usfw{attention layers} spielen dabei eine sehr große Rolle.
...
Ich plane für meine Facharbeit, ein sehr persönliches Problem zu behandeln: Alle bekannten und beliebten Bildschirmtastaturen sind nicht quelloffen und ganz sicher nicht kostenlos -- man zahlt nur meistens nicht mit Geld. Die Tastaturen, die quelloffen sind, sind im Aussehen -- wenn überhaupt -- nicht weit von den anderen entfernt, welche Funktionen bei ihnen aber besonders unausgeprägt sind, sind Sprachkorrektur und -vorhersage.

Grund dafür ist ziemlich sicher das ambivalente Verhältnis von vielen Nutzer, die viele Daten produzieren, und einer Tastatur, die nur durch viele Daten besser und bekannter wird. Ein weniger Privatsphäre-freundlicher Ansatz spielt sicher auch in die große Datenbasis der Superkonzerne Microsoft, Google und Apple hinein.

Eine mögliche Zielsetzung für die folgende Facharbeit ist also die Entwicklung eines Prototyps zur Sprachkorrektur und/oder -vorhersage am Beispiel von Bildschirmtastaturen. Dabei muss nicht unbedingt das Niveau der führenden Algorithmen erreicht werden -- das wäre unrealistisch --, aber möglicherweise das der quelloffenen.

Neben diesem ambitionierten Ziel steht allerdings auch grundsätzlich die Auseinandersetzung mit den alten und neuen, aber hauptsächlich erfolgreichsten Ansätzen der Sprachkorrektur- und -vorhersagealgorithmen und ob die Theorie in der Praxis bestätigt oder entkräftet wird.
...
\begin{itemize}
    ...
    \item Vergleichstests mit anderen Algorithmen von zum Beispiel den quelloffenen Bildschirmtastaturen oder aber den großen, nicht quelloffenen, oder
...
Sprachverarbeitung ist schließlich ein sich rasant weiter entwickelndes Feld, in dem mit großen Ambitionen geforscht und in das vor allen Dingen mit viel Geld investiert wird. Neu entwickelte Technologien können ältere schnell übertreffen und für den Normalgebrauch irrelevant machen.
