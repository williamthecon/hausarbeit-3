...
\newcommand{\ct}[2]{\footnote{\cite[#2]{#1}}} % cite (normal: source, location)
\newcommand{\ctr}[1]{\footnote{\cite{#1}}} % cite ("raw": only source)
\usepackage{xparse}
...
Während berührungsempfindliche Bildschirme schon seit den 1960ern existieren und erforscht wurden \ct{newhavendisplay_touchscreen_types_history}{Abs. 6 ff.}, wurden Bildschirmtastaturen erst in den späten 1980ern und 1990ern entwickelt \ctr{espacenet_us4725694_a}: Das erste bekannte Beispiel ist hierbei das IBM Simon aus dem November 1993, das einen mit einem Eingabestift bedienbaren Bildschirm besaß, der neben E-Mail, Kalender, Dateisystem und Notizen auch die dafür nötige Bildschirmtastatur darbot\ctr{mobilephonemuseum_ibm_simon}.

Während Bildschirmtastaturen schon in den späten 1980ern bis frühen 1990ern kommerziell zum Einsatz kamen \ct{?}{?}, machte erst Apple 2007 das Konzept beim Massenpublikum populär, als es mit seinem zur damaligen Zeit noch relativ unbekannten multitouchfähigen Bildschirm \ct{apple_iphone_praesentation_video}{7:12--7:36}, der also mehrere Berührungspunkte erkennen und darauf reagieren konnte, auf dem ersten iPhone eine funktionsfähige Bildschirmtastatur der Welt präsentierte \ct{apple_iphone_praesentation_video}{31:21--31:35}. Obwohl Steve Jobs von der \qt{Erfindung}\ct{apple_iphone_praesentation_video}{7:12--7:16} und \qt{Patentierung}\ct{apple_iphone_praesentation_video}{7:37--7:39} des multitouchfähigen Bildschirms gesprochen hat, sind sowohl die Funktion als auch der Name schon lange vorher entstanden \ct{?}{?}. Andere Versuche einer funktionsfähigen Bildschirmtastatur auf solch kleinen Bildschirmen litten jedoch bis zu dem Zeitpunkt an großer Ungenauigkeit und schwerer Bedienung \ct{?}{?}.
...
In der Anwendung zeichnet es sich vermeintlich vor allem durch seine Schreibgeschwindigkeit aus \ct{swype_product}{}, die zwar für den Guinness Weltrekord für das schnellste Tippen einer Textnachricht bekannt war \ct{techcrunch_swype_guinness_world_record}{}, es inzwischen aber nicht mehr ist \ctsr{guinnessworldrecords_fastest_text_message_type,guinnessworldrecords_fastest_text_message_swype_type} und die in Wirklichkeit nicht besser als bei herkömmlichen Tastaturen ist \ct{sagepub_shape_writing_on_tablets}{Zusammenfassung}, wenn man dieser Studie von 2012 Glauben schenkt, die allerdings die kontextuelle Komponente des Wortbestimmungsalgorithmus ausgeschaltet hat, was die Fähigkeiten dieser Art von Tastatur besonders in Grenzfällen verringert \ct{grammarly_swipe_typing_keyboard}{Abs. 7--10}.
